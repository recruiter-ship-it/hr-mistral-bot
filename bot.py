...
73	- РАССУЖДЕНИЕ (Chain of Thought): Перед тем как дать финальный ответ на сложный вопрос, мысленно проанализируй задачу, разбей её на шаги и убедись в логичности выводов. Твой ответ должен быть результатом глубокого анализа.
74	- ОБЯЗАТЕЛЬНО используй Markdown форматирование для улучшения читаемости: **жирный текст**, *курсив*, списки, заголовки.
75	- Будь дружелюбным и поддерживающим, но сохраняй профессионализм.
76	"""# Инициализация клиента Mistral
